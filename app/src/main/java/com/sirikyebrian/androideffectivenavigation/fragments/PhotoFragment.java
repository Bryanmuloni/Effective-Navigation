...
import com.sirikyebrian.androideffectivenavigation.BuildConfig;
...
public class PhotoFragment extends Fragment {
    ...
    private void openCamera(){
        ...
        mOutputUri = FileProvider.getUriForFile(getActivity(), BuildConfig.APPLICATION_ID +
    ...
    private static File getOutputMediaFile(){
        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES), "Effective Navigation");
